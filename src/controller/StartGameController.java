...
import view.SetupGame.NewGamePanel;
...
public class StartGameController implements ActionListener {
     ...
     */
    public StartGameController(MainFrame view, GameManager gameModel, UserManager userModel) {
        this.view = view;
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
            case NewGamePanel.BTN_SETTINGS:
                view.getSettingsPanel().setPrevious(view.getNewGamePanel());
                view.updateView(view.getNewGamePanel(), view.getSettingsPanel());
                break;
            case NewGamePanel.BTN_BACK:
                view.getNewGamePanel().resetUI();
                view.updateView(view.getNewGamePanel(), view.getMenuPanel());
                break;
            case NewGamePanel.BTN_MAPS:
                view.getNewGamePanel().openFileChooser();
                break;
            case NewGamePanel.BTN_START:
                if (startNewGame()) {
                    ...
                    view.updateView(view.getNewGamePanel(), mapPanel);
                    view.getMapPanel().startGame();
                }
                break;
            case NewGamePanel.BTN_COLOR+"0":
                view.changeSelectedColour(0, selectedColour);
                selectedColour = 0;
                break;
            case NewGamePanel.BTN_COLOR+"1":
                view.changeSelectedColour(1, selectedColour);
                selectedColour = 1;
                break;
            case NewGamePanel.BTN_COLOR+"2":
                view.changeSelectedColour(2, selectedColour);
                selectedColour = 2;
                break;
            case NewGamePanel.BTN_COLOR+"3":
                view.changeSelectedColour(3, selectedColour);
                selectedColour = 3;
                break;
            case NewGamePanel.BTN_COLOR+"4":
                view.changeSelectedColour(4, selectedColour);
                selectedColour = 4;
                break;
            case NewGamePanel.BTN_COLOR+"5":
                view.changeSelectedColour(5, selectedColour);
                selectedColour = 5;
                break;
            case NewGamePanel.BTN_COLOR+"6":
                view.changeSelectedColour(6, selectedColour);
                selectedColour = 6;
                break;
            case NewGamePanel.BTN_COLOR+"7":
                view.changeSelectedColour(7, selectedColour);
                selectedColour = 7;
                break;
            case NewGamePanel.BTN_COLOR+"8":
                view.changeSelectedColour(8, selectedColour);
                selectedColour = 8;
                break;
            case NewGamePanel.BTN_COLOR+"9":
                view.changeSelectedColour(9, selectedColour);
                selectedColour = 9;
                break;
            case NewGamePanel.BTN_COLOR+"10":
                view.changeSelectedColour(10, selectedColour);
                selectedColour = 10;
                break;
            case NewGamePanel.BTN_COLOR+"11":
                view.changeSelectedColour(11, selectedColour);
                selectedColour = 11;
                break;
        }
    }
    ...
    private boolean startNewGame() {
        Game game = view.getNewGamePanel().createNewGame();
        if (game == null) {
